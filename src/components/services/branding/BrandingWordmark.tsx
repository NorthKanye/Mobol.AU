import { WORDMARK_LABELS } from "./BrandingMockup";
  ...
  return (
    ...
    >
      ...
      <div className="wm-stack flex-1 relative flex items-center justify-center min-h-0">
        ...
        <div
          className={`wm-row ${activeIdx === 1 ? "wm-show" : ""} absolute inset-0 flex items-center justify-center text-ink whitespace-nowrap font-serif italic`}
          style={{
            fontWeight: 400,
        ...
        <div
          className={`wm-row ${activeIdx === 2 ? "wm-show" : ""} absolute inset-0 flex items-center justify-center text-ink whitespace-nowrap font-mono`}
          style={{
            fontWeight: 500,
            letterSpacing: "0.02em",
        ...
        >
          <span
            className="inline-block align-middle rounded-full bg-[#C75A3A]"
            style={{
              width: "0.55em",
              height: "0.55em",
              marginRight: "0.18em",
      ...
      <div className="wm-meta flex-shrink-0 flex items-center justify-between font-mono text-[10px] text-ink-2 pt-2 border-t border-dashed border-[#e3dfd6] mt-2">
        <span>{styleLabel}</span>
        <span className="text-ink-3 tabular-nums">{pagerCur}/5</span>
      </div>
    </div>
  );
}
